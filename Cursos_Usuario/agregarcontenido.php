...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($Titulo) || empty($Tipo) || ($Tipo != 'enlace' && empty($Archivo))) {
        ...
        $stmt->execute([$IDCurso, $Titulo, $Tipo, $Archivo, $Bloqueado]);

        header("Location: contenido.php?id=$IDCurso&mensaje=Contenido creado correctamente");
        exit;
    }
}
...
<div class="container mt-5 mb-5">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h2 class="mb-4"><i class="bi bi-plus-circle"></i> Agregar Contenido al Curso</h2>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light" 
                                   value="<?= htmlspecialchars($curso['Nombre'] ?? 'Curso no encontrado') ?>" disabled />
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-4">
                            <a href="contenido.php?id=<?= $IDCurso ?>" class="btn btn-secondary btn-lg">
