...
if(isset($_GET["txtID"])){
    ...
    if($registro){
        ...
        $OrdenContenido = $registro["OrdenContenido"];
...
if($_POST){
    ...
    if(empty($IDCurso) || empty($Titulo) || empty($Tipo) || empty($Archivo)) {
        ...
        $sentencia = $conexion->prepare("UPDATE Contenido SET
            IDCurso = :IDCurso,
            Titulo = :Titulo,
            Tipo = :Tipo,
            Archivo = :Archivo,
            ...
            <div class="card shadow-lg border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <label class="form-label fw-bold"><i class="bi bi-hash"></i> ID:</label>
                            <input type="text" value="<?= $txtID ?>" class="form-control form-control-lg bg-light" disabled />
                        </div>

                        <div class="mb-4">
                            <label for="IDCurso" class="form-label fw-bold"><i class="bi bi-journal-text"></i> Curso:</label>
                        ...
                        <div class="mb-4">
                            <label for="OrdenContenido" class="form-label fw-bold"><i class="bi bi-sort-numeric-up"></i> Orden:</label>
